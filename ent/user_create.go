...
func (uc *UserCreate) AddCheckinIDs(ids ...int) *UserCreate {
	uc.mutation.AddCheckinIDs(ids...)
	return uc
}

// AddCheckins adds the "checkins" edges to the Checkin entity.
func (uc *UserCreate) AddCheckins(c ...*Checkin) *UserCreate {
	ids := make([]int, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return uc.AddCheckinIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.CheckinsIDs(); len(nodes) > 0 {
